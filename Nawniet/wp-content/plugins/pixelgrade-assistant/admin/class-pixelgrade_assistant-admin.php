...
class PixelgradeAssistant_Admin {
	...
	public function add_pixelgrade_assistant_menu() {
        ...
        add_menu_page( esc_html__( 'Pixelgrade Assistant Dashboard', 'pixelgrade-assistant' ), esc_html__( 'Pixelgrade', 'pixelgrade-assistant' ) . $bubble_markup, 'install_themes', 'pixelgrade_assistant', array(
            $this,
            'pixelgrade_assistant_options_page',
        ), plugin_dir_url( $this->parent->file ) . 'admin/images/pixelgrade-menu-image.svg', 2 );
        add_submenu_page( 'pixelgrade_assistant', esc_html__( 'Dashboard', 'pixelgrade-assistant' ), esc_html__( 'Dashboard', 'pixelgrade-assistant' ), 'manage_options', 'pixelgrade_assistant', array(
            $this,
            'pixelgrade_assistant_options_page',
        ) );
    }
    ...
    public function add_tabs() {
        ...
        $screen->add_help_tab( array(
            ...
            'title'   => esc_html__( 'Pixelgrade Assistant', 'pixelgrade-assistant' ),
            'content' =>
                '<h2>' . esc_html__( 'Pixelgrade Assistant Site Setup', 'pixelgrade-assistant' ) . '</h2>' .
                '<p><a href="' . esc_url( admin_url( 'index.php?page=pixelgrade_assistant-setup-wizard' ) ) . '" class="button button-primary">' . esc_html__( 'Setup Pixelgrade Assistant', 'pixelgrade-assistant' ) . '</a></p>',
        ) );
    }
