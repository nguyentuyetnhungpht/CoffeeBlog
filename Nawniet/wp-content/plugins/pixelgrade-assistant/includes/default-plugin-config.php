...
function pixassist_get_default_config( $original_theme_slug ){
	...
	$config['l10n'] = array(
		...
		'themeValidationNoticeUpdateAvailable'     => esc_html__( 'A New Theme Update is Available!', 'pixelgrade-assistant' ),
		...
		'themeUpdateAvailableContent'   => esc_html__( 'Great news! A brand new theme update is waiting.', 'pixelgrade-assistant' ),
		'hashidNotFoundNotice'          => esc_html__( 'Sorry but we could not recognize your theme. This might have happened because you have made changes to your theme files. If that is the case - please try to revert to the original theme files.', 'pixelgrade-assistant' ),
		'themeUpdateButton'             => esc_html__( 'Update', 'pixelgrade-assistant' ),
		...
		'themeDirectoryChangedTitle'    => esc_html__( 'Your theme DIRECTORY is not as intended!', 'pixelgrade-assistant' ),
		'themeDirectoryChanged'         => sprintf( esc_html__( 'This will give you all kinds of trouble when updating the theme. To be able to successfully install updates please change the theme directory name to "%s".', 'pixelgrade-assistant' ), $original_theme_slug ),
		'themeNameChangedTitle'         => esc_html__( 'Your theme NAME is changed!', 'pixelgrade-assistant' ),
		'themeNameChanged'              => sprintf( esc_html__( 'The next time you update your theme this name will be changed back to "%s"', 'pixelgrade-assistant' ), $original_theme_slug ),
		'childThemeNameChanged'         => sprintf( esc_html__( 'On your next update, your parent theme name will be changed back to its original one: "%1$s". To avoid issues with your child theme, you will need to update the style.css file of both your parent and child theme with the original name: "%1$s".', 'pixelgrade-assistant' ), $original_theme_slug ),
		...
		'pluginsPlural' => esc_html__( 'Plugins', 'pixelgrade-assistant' ),
		'starterContentLoadLabel' => esc_html__( 'Load Starter Content', 'pixelgrade-assistant' ),
		...
		'setupWizardStartButonLabel' => esc_html__( 'Let\'s Get Started!', 'pixelgrade-assistant' ),
		...
		'authenticatorDashboardConnectedSuccessContent' => wp_kses_post( __( 'Well done, <strong>{{username}}</strong>! Your website is successfully connected with {{shopdomain}}. Carry on and install the recommended plugins or the starter content in the blink of an eye.', 'pixelgrade-assistant' ) ),
			...
			'blocks'   => array(
				'plugins' => array(
					...
					'fields' => array(
						'title'             => array(
							'type'  => 'h2',
							'value' => esc_html__( 'Install the recommended plugins', 'pixelgrade-assistant' ),
							'value_installing' => esc_html__( 'Installing Plugins..', 'pixelgrade-assistant' ),
							'value_installed' => '<span class="c-icon  c-icon--large  c-icon--success-auth"></span> ' . esc_html__( 'Plugins Installed!', 'pixelgrade-assistant' ) . ' 🤩',
						...
						'head_content'   => array(
							...
							'value_installed'  => esc_html__( 'You made it! 🙌 You\'ve correctly installed and activated the plugins. You are good to jump to the next step.', 'pixelgrade-assistant' ),
						),
			...
			'blocks'    =>  array(
				'support'   =>  array(
					...
					'fields' => array(
						'title'          => array(
							'type'  => 'h2',
							'value' => esc_html__( 'Load Starter Content', 'pixelgrade-assistant' ),
							'value_installing' => esc_html__( 'Loading Starter Content..', 'pixelgrade-assistant' ),
							'value_installed' => '<span class="c-icon  c-icon--large  c-icon--success-auth"></span> ' . esc_html__( 'Starter Content Loaded!', 'pixelgrade-assistant' ),
							'class' => 'section__title',
						),
						'head_content'   => array(
							'type'             => 'text',
							'value'            => esc_html__( 'Use the starter content to make your site look as eye-candy as the theme\'s demo. The importer helps you have a strong starting point for your content and speed up the entire process.', 'pixelgrade-assistant' ),
                ...
                'starterContent' => array(
                    ...
                    'fields' => array(
	                    'title'          => array(
		                    ...
		                    'value_installing' => esc_html__( 'Starter Content Installing..', 'pixelgrade-assistant' ),
		                    'value_installed' => '<span class="c-icon  c-icon--large  c-icon--success-auth"></span> ' . esc_html__( 'Starter Content Installed!', 'pixelgrade-assistant' ),
		                    'class' => 'section__title',
	                    ),
	                    'head_content'   => array(
		                    'type'             => 'text',
	...
	$config['starterContent'] = array(
		'l10n' => array(
			...
			'noSources' => esc_html__( 'Unfortunately, we don\'t have any starter content sources right now.', 'pixelgrade-assistant' ),
			'alreadyImportedConfirm' => esc_html__( 'The Starter Content was already imported! Are you sure you want to import it again?', 'pixelgrade-assistant' ),
			'alreadyImportedDenied' => esc_html__( 'It\'s OK!', 'pixelgrade-assistant' ),
			'importingData' => esc_html__( 'Getting data ...', 'pixelgrade-assistant' ),
	...
	$config['recommendedPlugins'] = array(
		// general strings
		'title'               => esc_html__( 'Recommended plugins', 'pixelgrade-assistant' ),
		...
		// validated string
		'validatedTitle'      => '<span class="c-icon c-icon--success"></span> ' . esc_html__( 'Recommended plugins ready 🧘️', 'pixelgrade-assistant' ),
		'validatedContent'    => wp_kses_post( __( 'You can rest assured that {{theme_name}} can do it\'s best for you and your site.', 'pixelgrade-assistant' ) ),
	);
